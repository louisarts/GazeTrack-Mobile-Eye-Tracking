...
model, history = arch_4_conv_neural_network(
...
history_5_df = pd.DataFrame(history.history)
history_5_df.to_csv("../training_histories/model_5_history.csv", index=False)
