...
from model_training.training_helper_functions import arch_1_conv_neural_network, save_model, create_dataset
import pandas as pd
...
model, history = arch_1_conv_neural_network(HPARAMS["conv1_filters"],
...
history_1_df.to_csv("../training_histories/model_1_history.csv", index=False)
