...
from model_training.training_helper_functions import arch_2_conv_neural_network, save_model, create_dataset
import pandas as pd
...
model, history = arch_2_conv_neural_network(HPARAMS["conv1_filters"],
...
save_model(model, "../models/model_3")

history_1_df = pd.DataFrame(history.history)
history_1_df.to_csv("../training_histories/model_3_history.csv", index=False)