...
model, history = arch_3_conv_neural_network(
...
history_4_df = pd.DataFrame(history.history)
history_4_df.to_csv("../training_histories/model_4_history.csv", index=False)
