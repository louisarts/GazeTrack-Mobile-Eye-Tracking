...
# Mark rows where screen orientation is invalid
...
# Columns excluded from numeric validation
...
# Find invalid numeric data and remove related frames
rows_to_drop = []
...
# Drop invalid rows and save final dataset
